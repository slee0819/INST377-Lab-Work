...
function processRestaurants(list) {
  ...
  const range = [...Array(15).keys()]; // Special notation to creation an array of 15 elements
...
async function mainEvent() {
  ...
  */
  ...
  const loadAnimation = document.querySelector('.lds-ellipsis'); // get a refernece to our loading animation.
